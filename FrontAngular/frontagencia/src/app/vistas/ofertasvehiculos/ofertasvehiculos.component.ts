...
@Component({
  ...
  templateUrl: './ofertasvehiculos.component.html',
  styles: [`
    .custom-day {
      text-align: center;
...
export class OfertasVehiculosComponent{
  ...
  redirigeareserva(vehiculoid:String)
  {
    ...
    this.api.reservarVehiculo(vehiculoid, fech).subscribe(data =>
    {
      this.reservas = data;
      console.log(data);
    },
