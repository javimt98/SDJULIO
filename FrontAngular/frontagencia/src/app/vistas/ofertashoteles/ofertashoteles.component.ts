...
@Component({
  selector: 'app-ofertashoteles',
  templateUrl: './ofertashoteles.component.html',
  styles: [`
    .custom-day {
      text-align: center;
...
export class OfertashotelesComponent implements OnInit {
  ...
  redirigeareserva(hotelid:String)
  {
    ...
    this.api.reservarHotel(hotelid, fech).subscribe(data =>
    {
      this.reservas = data;
      console.log(data);
    },
